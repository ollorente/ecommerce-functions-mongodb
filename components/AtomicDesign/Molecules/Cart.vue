<template>
  <nuxt-link :to="`/producto/${product.id}`" target="_self" class="card">
    <div class="card grid col-1 col-xs-3 col-sm-3 col-md-4">
      <div class="card-body span-1 span-xs-1 span-sm-1">
        <img
          :src="product.image"
